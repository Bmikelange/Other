# Generated from MiniC.g4 by ANTLR 4.7.1
from antlr4 import *
...
class MiniCVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by MiniCParser#exprListNonEmpty.
    def visitExprListNonEmpty(self, ctx:MiniCParser.ExprListNonEmptyContext):
        return self.visitChildren(ctx)
