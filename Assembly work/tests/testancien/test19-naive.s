...
##Generated Code
        ...
        # (stat (while_stat while ( (expr (expr (expr (atom x)) <= (expr (atom 4))) || (expr (atom false))) ) (stat_block { (block (stat (assignment x = (expr (expr (atom x)) + (expr (atom 1)))) ;)) })))
lbl_ltest1_0:
        # li temp_3, 4
        li t3, 4
        # end li temp_3, 4
...
lbl_endrl_2:
        ...
        li t1, 0
        # end li temp_5, 0
        # or temp_6, temp_4, temp_5
        or t0, t2, t1
        # end or temp_6, temp_4, temp_5
